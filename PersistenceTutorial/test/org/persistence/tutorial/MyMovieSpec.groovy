...
//		}
	...
	def "Test of the MyMovie constructor with initialized title and genre"() {
		given: "Movie with title and genre"
			Movie m1 = new Movie("Matrix", "Action")
		expect: "Movie has its tile and genre which were inialized in the given block"
			m1.getTitle() == "Matrix"
			m1.getGenre() == "Action"
	}
...
//	}
	...
	def "Set a title to the movie"() {
		given: "Movie with a title and a genre"
			Movie m1 = new Movie("Matrix", "Action")
		when: "Set a new title to the movie"
			m1.setTitle("Interstellar")
...
//		}
	...
	def "Get person from the movie"() {
		...
		when: "I set person to the movie"
			m1.setPerson(p1)
		then: "Person setted to the movie is the person type"
			m1.getPerson() instanceof Person
		and: "Name of the person is unknown"
...
//	}
	...
	def "Test toString() method"() {
		given: "Movie with title and genre"
			Movie m1 = new Movie("Goodfellas", "Crime")
		expect: "Method toString() returns \"Goodfellas directed by unknown director; The genre of this movie is Crime; Available.\" text"
		...
		when: "I add person to the movie and set name of the person Arnold"
			...
			m1.setPerson(p1);
			p1.setName("Arnold");
		then: "Method toString() will return \"Goodfellas directed by unknown director; The genre of this movie is Crime; Checked out to Arnold.\" text"
